...
@section('content')
        ...
        <div class="row">
            @if($game->status != 'finalizado')
                <div class="col-md-12 text-right" style="margin: 0px">
                    <a href="{{ route('championshipscategories.show', ['championshipscategory' => $game->championships_category_id]) }}" class="btn btn-warning btn-lg" style="padding: 10px 20px; margin: 20px 2px"><i class="glyphicon glyphicon-arrow-left"></i> Salir</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-sm-4 text-center">
                            ...
                            @else
                                ...
                                <a href="{{ route('championshipscategories.show', ['championshipscategory' => $game->championships_category_id]) }}" class="btn btn-warning">Volver a la lista <i class="voyager-list"></i></a>
                            @endif
                        </div>
    ...
    {{-- Goal modal --}}
    <form id="form-goal" action="{{ route('championshipscategories.game.goal', ['id' => $game->id]) }}" method="post">
        @csrf
        <input type="hidden" name="championships_details_player_id">
    ...
    {{-- Card modal --}}
    <form id="form-card" action="{{ route('championshipscategories.game.card', ['id' => $game->id]) }}" method="post">
        @csrf
        <input type="hidden" name="championships_details_player_id">
    ...
    {{-- Card modal --}}
    <form id="form-change" action="{{ route('championshipscategories.game.change', ['id' => $game->id]) }}" method="post">
        @csrf
        <input type="hidden" name="championships_details_player_id">
    ...
    {{-- Finish modal --}}
    <form id="form-finish" action="{{ route('championshipscategories.game.finish', ['id' => $game->id]) }}" method="post">
        @csrf
        @php
            $winner_id = null;
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-goal').click(function(){
                ...
                $('#form-goal input[name="championships_details_player_id"]').val(item.id)
            ...
            $('.btn-card').click(function(){
                ...
                $('#form-card input[name="championships_details_player_id"]').val(item.id);
            ...
            $('.btn-change').click(function(){
                let item = $(this).data('item');
                let type = $(this).data('type');
                $('#form-change input[name="championships_details_player_id"]').val(item.id);
